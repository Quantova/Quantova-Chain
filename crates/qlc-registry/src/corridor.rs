...
pub fn corridor(id: NetworkId) -> Corridor {
    match id {
        NetworkId::Bitcoin => Corridor {
            id,
            name: "Bitcoin",
            tier: VerificationTier::Spv,
            finality: FinalityConfig::probabilistic(6, 6),
        },
        NetworkId::BitcoinCash => Corridor {
            id,
            name: "Bitcoin Cash",
            tier: VerificationTier::Spv,
            finality: FinalityConfig::probabilistic(10, 10),
        },
        NetworkId::Ethereum => Corridor {
            id,
            name: "Ethereum",
            tier: VerificationTier::LightClient,
            finality: FinalityConfig::deterministic(64),
        },
        NetworkId::BnbChain => Corridor {
            id,
            name: "BNB Chain",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::probabilistic(15, 15),
        },
        NetworkId::Polygon => Corridor {
            id,
            name: "Polygon",
            tier: VerificationTier::Federated,
        ...
        NetworkId::Gnosis => Corridor {
            id,
            name: "Gnosis",
            tier: VerificationTier::LightClient,
            finality: FinalityConfig::deterministic(64),
        },
        NetworkId::Linea => Corridor {
            id,
            name: "Linea",
            tier: VerificationTier::LightClient,
            finality: FinalityConfig::deterministic(64),
        },
        NetworkId::Scroll => Corridor {
            id,
            name: "Scroll",
            tier: VerificationTier::LightClient,
            finality: FinalityConfig::deterministic(64),
        },
        NetworkId::ZkSyncEra => Corridor {
            id,
            name: "zkSync Era",
            tier: VerificationTier::LightClient,
            finality: FinalityConfig::deterministic(64),
        },
        NetworkId::Mantle => Corridor {
            id,
            name: "Mantle",
            tier: VerificationTier::LightClient,
            finality: FinalityConfig::deterministic(64),
        },
        NetworkId::Celo => Corridor {
            id,
            name: "Celo",
            tier: VerificationTier::LightClient,
            finality: FinalityConfig::deterministic(1),
        },
        NetworkId::CosmosHub => Corridor {
            id,
            name: "Cosmos Hub",
            tier: VerificationTier::LightClient,
            finality: FinalityConfig::deterministic(1),
        },
        NetworkId::Osmosis => Corridor {
            id,
            name: "Osmosis",
            tier: VerificationTier::LightClient,
            finality: FinalityConfig::deterministic(1),
        },
        NetworkId::Celestia => Corridor {
            id,
            name: "Celestia",
            tier: VerificationTier::LightClient,
            finality: FinalityConfig::deterministic(1),
        },
        NetworkId::Injective => Corridor {
            id,
            name: "Injective",
            tier: VerificationTier::LightClient,
            finality: FinalityConfig::deterministic(1),
        },
        NetworkId::Sei => Corridor {
            id,
            name: "Sei",
            tier: VerificationTier::LightClient,
            finality: FinalityConfig::deterministic(1),
        ...
        NetworkId::Solana => Corridor {
            ...
            name: "Solana",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::deterministic(32),
        },
        NetworkId::Tron => Corridor {
            id,
            name: "TRON",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::deterministic(19),
        },
        NetworkId::XrpLedger => Corridor {
            id,
            name: "XRP Ledger",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::deterministic(1),
        },
        NetworkId::Cardano => Corridor {
            id,
            name: "Cardano",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::probabilistic(15, 15),
        ...
        NetworkId::Sui => Corridor {
            id,
            name: "Sui",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::deterministic(1),
        },
        NetworkId::Aptos => Corridor {
            id,
            name: "Aptos",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::deterministic(1),
        },
        NetworkId::Hedera => Corridor {
            id,
            name: "Hedera",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::deterministic(1),
        },
        NetworkId::Algorand => Corridor {
            id,
            name: "Algorand",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::deterministic(1),
        },
        NetworkId::Ton => Corridor {
            id,
            name: "Ton",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::deterministic(1),
        },
        NetworkId::Stellar => Corridor {
            id,
            name: "Stellar",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::deterministic(1),
        ...
        NetworkId::Litecoin => Corridor {
            id,
            name: "Litecoin",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::probabilistic(12, 12),
        },
        NetworkId::Dogecoin => Corridor {
            id,
            name: "Dogecoin",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::probabilistic(30, 30),
        },
        NetworkId::Zcash => Corridor {
            id,
            name: "Zcash",
            tier: VerificationTier::Federated,
        ...
        NetworkId::Cctp => Corridor {
            ...
            name: "Circle CCTP",
            tier: VerificationTier::Federated,
            finality: FinalityConfig::probabilistic(20, 20),
        },
    }
}
